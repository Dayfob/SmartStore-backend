			...
			<div class="content-wrap">
								...
								<div class="flexslider">
									<div class="slider-wrap">
										<div class="slide">
                                            @for ($i = 1; $i <= 4; $i++)
											<a href="#">
												<img src="{{ asset('images/shop/slider/'. $i .'.jpg') }}" alt="Shop Image">
											</a>
                                            @endfor
										</div>
									</div>
						...
						<div class="col-xl-4">
							<div class="row align-items-stretch gutter-20 min-vh-25 h-100">
								<div class="col-12 col-md-6 col-xl-12 min-vh-25 min-vh-md-0">
									<a href="#" class="grid-inner d-block h-100" style="background-image: url({{ asset('images/shop/banners/7.jpg') }});"></a>
								</div>

								<div class="col-12 col-md-6 col-xl-12 min-vh-25 min-vh-md-0 pb-xl-0">
									<a href="#" class="grid-inner d-block h-100" style="background-image: url({{ asset('images/shop/banners/3.jpg') }});"></a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="container">
					...
					<div id="oc-clients-full" class="owl-carousel image-carousel carousel-widget" data-margin="30" data-nav="false" data-autoplay="5000" data-pagi="false" data-items-xs="2" data-items-sm="3" data-items-md="4" data-items-lg="5" data-items-xl="7">
                        ...
                        @for ($i = 1; $i <= 16; $i++)
                            <div class="oc-item"><a href="#"><img src="{{ asset('images/clients/logo/'. $i .'.png')}}"
                                                                  alt="Clients"></a></div>
                        @endfor
